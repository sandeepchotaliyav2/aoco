...
<section class="content">
    ...
    <div class="col-lg-10 col-lg-offset-1">
        ...
        <div class="box box-primary">
            ...
            <form role="form" method="PUT" action="{{ route('updaterequest', $data['id']) }}">
                {{ csrf_field() }}
                <div class="box-body">
                    <div class="form-group{{ $errors->has('crm_case') ? ' has-error' : '' }}">
                        <label for="crm">CRM</label>

                        <input id="crm" type="text" class="form-control" name="crm_case" placeholder="Enter CRM" value="{{ $data['crm_case'] }}" required autofocus> 
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="work_type">
                            ...
                            @foreach ($worktype as $key1 => $work)
                            @if( $work['name'] == $data['worktype'])
                                {{ }}
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="sub_work_type">
                            ...
                            @foreach ($mdutype as $key2 => $mdu)
                            <option value=" {{ $mdu['name'] }}"> {{ $mdu['name'] }} </option>
                            @endforeach
                        </select>
                    </div>
